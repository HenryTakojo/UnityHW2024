...
public class Map : MonoBehaviour
{
    ...
    public double centerLongitude = 25.07610887129799; //Change to the longitude of the centre of the area you need
    public double centerLatitude = 121.37610193997288; //Change to the latitude of the centre of the area you need
    ...
    {
        int zoom = (int)Camera.main.orthographicSize;
        ...
        url = $"https://maps.googleapis.com/maps/api/staticmap?center={centerLatitude},{centerLongitude}&zoom={zoom}&size={width}x{height}&key={accessToken}";
